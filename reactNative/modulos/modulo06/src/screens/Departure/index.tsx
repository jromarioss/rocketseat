  ...
  async function handleDepartureRegister() {
    try{
      ...
      if(description.trim().length === 0) {
        ...
        return Alert.alert('Finalidade.', 'Por favor, informe uma finalidade!')
      }
      ...
      if (!backgroundPermissions.granted) {
        ...
        return Alert.alert("Localização", "É necessário permitir que o app tenha acesso a localização")
      }

      await startLocationTask(); // inicia a tarefa
